"""BUR (Burrow) Lifecycle Dashboard — Streamlit Cloud entry point.
...
scripts/lifecycle_dashboard.py.

To deploy on Streamlit Cloud:
  Repository: this repo
  Branch:     main
  Main file:  streamlit-deploy-bur/app.py
"""
import sys
...
_src = _root / "scripts" / "lifecycle_dashboard.py"
exec(  # noqa: S102
