"""HAV (Havenly) Lifecycle Dashboard — Streamlit Cloud entry point.
...
scripts/hav_lifecycle_dashboard.py.

To deploy on Streamlit Cloud:
  Repository: this repo
  Branch:     main
  Main file:  streamlit-deploy-hav/app.py
"""
import sys
...
_src = _root / "scripts" / "hav_lifecycle_dashboard.py"
exec(  # noqa: S102
