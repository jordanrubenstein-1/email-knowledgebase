"""Email Deliverability Dashboard — Streamlit Cloud entry point.
...
scripts/deliverability_dashboard.py.

To deploy on Streamlit Cloud:
  Repository: this repo
  Branch:     main
  Main file:  streamlit-deploy-deliverability/app.py
"""
import sys
...
_src = _root / "scripts" / "deliverability_dashboard.py"
exec(  # noqa: S102
