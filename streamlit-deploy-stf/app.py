"""STF (St. Frank) Lifecycle Dashboard — Streamlit Cloud entry point.
...
scripts/stf_lifecycle_dashboard.py.

To deploy on Streamlit Cloud:
  Repository: this repo
  Branch:     main
  Main file:  streamlit-deploy-stf/app.py
"""
import sys
...
_src = _root / "scripts" / "stf_lifecycle_dashboard.py"
exec(  # noqa: S102
