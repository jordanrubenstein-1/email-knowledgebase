#!/usr/bin/env python3
"""Build HAV PT Welcome Gift — Test B, Day 1 template."""
import sys
...
BODY_HTML = """\
          ...
          <p style="margin:0;margin-bottom:0;">Your designer is ready to help you find pieces you&rsquo;ll love. {% if {{custom_attribute.${last_stage}}} != 'launch_room' and {{custom_attribute.${last_stage}}} != 'design_process_complete' %}We recommend <a href="https://havenly.com/rooms" style="color:#0000EE;text-decoration:underline;">completing your room profile</a> and scheduling time with them soon &mdash; {% endif %}they&rsquo;ll guide you through the process and help you pick the perfect items for your space.</p>
          <p style="margin:0;margin-bottom:0;">&nbsp;</p>
