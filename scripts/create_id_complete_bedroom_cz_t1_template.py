#!/usr/bin/env python3
"""
Build TRG_EM_2026_06_ID_D_Complete_Your_Bedroom_CZ_T1_V1 email template.

Downloads Slice 1–7 from Google Drive, uploads to Braze CDN (ID brand),
assembles HTML using the ID designed email structure, and creates the template
via Braze Templates API.

Usage:
    uv run python scripts/create_id_complete_bedroom_cz_t1_template.py
    uv run python scripts/create_id_complete_bedroom_cz_t1_template.py --dry-run
"""
...
BRAND = "ID"
TEMPLATE_NAME = "TRG_EM_2026_06_ID_D_Complete_Your_Bedroom_CZ_T1_V1"
SUBJECT = "The rug your feet will thank you for"
PREHEADER = "Ethically sourced bedding and rugs from The Citizenry, curated to complete your new space."
DRIVE_FOLDER_URL = "https://drive.google.com/drive/folders/1jUO_Hja-ft5VpHmZeEsT5Wzds1_WTnNM"
...
SLICES = [
    ...
    {"name": "Slice 4.png", "link": "https://www.the-citizenry.com/collections/organic-cotton-bedding", "alt": "Organic Bedding"},
    {"name": "Slice 5.png", "link": "https://www.the-citizenry.com/collections/shop-all-rugs-1?Type=Hand-Knotted", "alt": "Hand-Knotted Rugs"},
    {"name": "Slice 6.png", "link": "https://www.the-citizenry.com/collections/all-throw-pillows", "alt": "Throw Pillows"},
    {"name": "Slice 7.png", "link": "https://havenly.com/ai-interior-design", "alt": "AI Interior Design"},
]
...
def download_slices(dest_dir: Path) -> dict:
    """Download Slice 1–7 from Google Drive. Returns {filename: local_path}."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Create ID Complete Your Bedroom CZ T1 email template"
    )
