#!/usr/bin/env python3
"""
Build HAV PT Welcome Gift Email — Test A, Day 30 template.
...
TEMPLATE_NAME = "TRG_EM_2026_06_HAV_CONV_PT_Welcome_Gift_T3_V1_A"
SUBJECT = "Ready to complete your space?"

BASE_DIR = Path(__file__).parent.parent
TEMPLATE_PATH = BASE_DIR / "components" / "hav_pt_template.html"

# 9 days = 9 * 86400 = 777600 seconds
BODY_HTML = """\
          <p style="margin:0;margin-bottom:0;">There&rsquo;s nothing quite like the feeling of a room finally coming together &mdash; and we&rsquo;d love to help you get there!</p>
          <p style="margin:0;margin-bottom:0;">&nbsp;</p>
          <p style="margin:0;margin-bottom:0;">Your designer is still here to help you find the perfect pieces to complete your space. And when you&rsquo;re ready to purchase, your offer is waiting:</p>
          <p style="margin:0;margin-bottom:0;">&nbsp;</p>
          <p style="margin:0;margin-bottom:0;"><strong>Use code GETSTARTED for 10% off your first purchase.</strong></p>
          <p style="margin:0;margin-bottom:0;">&nbsp;</p>
