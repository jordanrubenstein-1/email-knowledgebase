#!/usr/bin/env python3
"""
Build HAV PT Welcome Gift Email — Test A, Day 10 template.
...
BODY_HTML = """\
          ...
          <p style="margin:0;margin-bottom:0;">&nbsp;</p>
          <p style="margin:0;margin-bottom:0;">Your perfect space is closer than you think, we can&rsquo;t wait to see it come together!</p>
          <p style="margin:0;margin-bottom:0;">&nbsp;</p>
