...
#
# BUR is mid-migration from "braze_BW"/"burrow" to "braze_burrow" (spelling
# out the brand name instead of the internal "BW" code) — accept all three
# until the older values stop appearing in new sends (tracked: several
# weeks from 2026-09-11).
BRAND_UTM_SOURCES: Dict[str, Tuple[str, ...]] = {
    "HAV": ("braze_HAV",),
    "CZ": ("braze_CZ",),
    "ID": ("braze_ID",),
    "BUR": ("braze_burrow", "braze_BW", "burrow"),
    "STF": ("braze_SF",),
    "TI": ("braze_TI",),
}
