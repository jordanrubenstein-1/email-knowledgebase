...
_base.HAS_SMS       = True
_base.HAS_SWATCHES  = True
_base.SWATCH_GA4_COL = '"KEYEVENTS:GENERATE_LEAD_SWATCH"'
_base.BRAZE_TIER3   = True
# Confirmed bot/fraud signup-bombing traffic (2026-07) — excluded from all live
# datashare metrics so Welcome/Abandon Browse volumes reflect real traffic.
_base.EXCLUDED_BOT_EMAILS = [
    "mmcloughlin@boarsheadresort.com",
    "laura@legallycopied.com",
    "cdelpriore@graceofny.org",
]
...
_base.CANVAS_GROUP_RULES = [
    (["welcome"],                                          "Welcome"),
    (["swatch post purchase"],                             "Swatch Post Purchase"),
    (["swatch cart", "swatch"],                           "Swatch Abandon"),
    (["cart"],                                            "Abandon Cart"),
    (["browse", "collection abandon", "category abandon"],"Abandon Browse"),
    (["crossbrand"],                                      "Post Purchase — Cross-Sell"),
    (["post purchase"],                                   "Post Purchase"),
    (["trade"],                                           "Trade Welcome"),
]
_base.GA4_CANVAS_RULES = [
    (["welcome"],                                          "Welcome"),
    (["swatch_post", "swatch post"],                      "Swatch Post Purchase"),
    (["swatch"],                                          "Swatch Abandon"),
    (["cart"],                                            "Abandon Cart"),
    (["browse", "collection", "category"],                "Abandon Browse"),
    (["bedroom_cz", "living_room_cz"],                    "Post Purchase — Cross-Sell"),
    (["post purchase", "post-purchase", "post_purchase"], "Post Purchase"),
    (["trade"],                                           "Trade Welcome"),
]
