"""ID (Interior Define) Lifecycle Dashboard — Streamlit Cloud entry point.
...
scripts/id_lifecycle_dashboard.py.

To deploy on Streamlit Cloud:
  Repository: this repo
  Branch:     main
  Main file:  streamlit-deploy-id/app.py
"""
import sys
...
_src = _root / "scripts" / "id_lifecycle_dashboard.py"
exec(  # noqa: S102
